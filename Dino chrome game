...
TFT_eSprite img = TFT_eSprite(&tft);       // Main game sprite
TFT_eSprite img2 = TFT_eSprite(&tft);      // Dinosaur sprite
TFT_eSprite e = TFT_eSprite(&tft);        // Enemy 1 sprite
TFT_eSprite e2 = TFT_eSprite(&tft);       // Enemy 2 sprite
...
PROGMEM unsigned char cloud[] = {
    0x00, 0x00, 0x7C, 0x00, 0x00, 0x00, 0x80, 0xCF, 0x01, 0x00, 0x00, 0xE0, 0x01, 0x03, 0x00, 0x00, 0x60, 0x00, 0x0F, 0x00, 0x00, 0x38, 0x00, 0xFE, 0x00, 0x00, 0x3C, 0x30, 0xA8, 0x03, 0xE0, 0x0F, 0x00, 0x80, 0x07, 0x70, 0x05, 0x03, 0x00, 0x0E, 0x18, 0x00, 0x00, 0x02, 0x08, 0x0E, 0x00, 0x00, 0x00, 0x18, 0xFF, 0xFF, 0xFF, 0xFF, 0x3F
};

// Bump images
PROGMEM unsigned char bump[][170] = {
    // Bump frame 1
    {0xC0, 0x01, 0x00, 0x1E, 0x00, 0x30, 0x03, 0x00, 0x33, 0x00, 0x1C, 0x0E, 0xC0, 0xE0, 0x00, 0x06, 0x18, 0xF0, 0x80, 0x01, 0x03, 0xF0, 0x1F, 0x00, 0x03},
    // Bump frame 2
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x01, 0x00, 0x00, 0x00, 0x30, 0x0E, 0xC0, 0x00, 0x00, 0x18, 0x98, 0xF3, 0xC1, 0x01, 0x07, 0xF0, 0x1F, 0x3E, 0x03}
};
...
PROGMEM unsigned char enemy[][684] = {
    ...
    // Enemy frame 2
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x80, 0x03, 0x00, 0xC0, 0x07, 0x00, 0xC0, 0x07, 0x00, 0xC0, 0x07, 0x00, 0xC0, 0x47, 0x00, 0xC0, 0xE7, 0x00, 0xC0, 0xE7, 0x00, 0xC0, 0xE7, 0x00, 0xC4, 0xE7, 0x00, 0xCE, 0xE7, 0x00, 0xCE, 0xE7, 0x00, 0xCE, 0xE7, 0x00, 0xCE, 0xE7, 0x00, 0xCE, 0xE7, 0x00, 0xCE, 0xF7, 0x00, 0xCE, 0xFF, 0x00, 0xCE, 0x7F, 0x00, 0xCE, 0x3F, 0x00, 0xDE, 0x07, 0x00, 0xFE, 0x07, 0x00, 0xFC, 0x07, 0x00, 0xF8, 0x07, 0x00, 0xC0, 0x07, 0x00, 0xC0, 0x07, 0x00, 0xC0, 0x07, 0x00, 0xC0, 0x07, 0x00, 0xC0, 0x07, 0x00, 0xC0, 0x07, 0x00, 0xC0, 0x07, 0x00, 0xC0, 0x07, 0x00, 0xC0, 0x07, 0x00}
};
...
void setup() {
    ...
    analogWrite(TFT_BL, brightnes[b]);
...
void drawS(int x, int y, int frame) {
    ...
    for (int m = 0; m < 2; m++) {
        eX[m] = eX[m] - sped;
        if (eX[m] < -20) eX[m] = random(240, 300);
        ef[m] = random(0, 2);
    }
